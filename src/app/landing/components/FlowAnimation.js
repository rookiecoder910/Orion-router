...
export default function FlowAnimation() {
  ...
  return (
    <div className="mt-16 w-full max-w-4xl relative h-[360px] hidden md:flex items-center justify-center animate-[float_6s_ease-in-out_infinite]">
      {/* OrionRouter Hub - Center */}
      <div className="relative z-20 w-32 h-32 rounded-full bg-[#181411] border-2 border-[#f97815] shadow-[0_0_40px_rgba(249,120,21,0.3)] flex flex-col items-center justify-center gap-1 group cursor-pointer hover:scale-105 transition-transform duration-500 overflow-hidden p-2">
        <img src="/logo.png" alt="OrionRouter" className="size-12 object-contain" />
