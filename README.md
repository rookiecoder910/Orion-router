<div align="center">
  ...
  # OrionRouter - Terminal AI Gateway & Token Saver
  
  **Never stop coding. Save 20-40% tokens with RTK + auto-fallback to FREE & cheap AI models.**
  
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw, Zed IDE...) to 40+ AI Providers & 100+ Models.**
  
  *High-contrast Cyber-Industrial Terminal CLI Aesthetic // Monospace Supremacy // Phosphor CRT Scanlines*

[🚀 Quick Start](#-quick-start) • [📸 Screenshots](#-screenshots) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide)
